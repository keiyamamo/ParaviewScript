...
# find source
pressure_25_to_1000_amplitude_time_averagevtu = FindSource('GreenLagrangeStrain_25_to_200_max_principal_amplitude_time_average.vtu')
...
pressure_averageLUT = GetColorTransferFunction('GreenLagrangeStrain_25_to_200_max_principal_amplitude_time_average')
...
pressure_averagePWF = GetOpacityTransferFunction('GreenLagrangeStrain_25_to_200_max_principal_amplitude_time_average')

# get 2D transfer function for 'pressure_average'
pressure_averageTF2D = GetTransferFunction2D('GreenLagrangeStrain_25_to_200_max_principal_amplitude_time_average')
