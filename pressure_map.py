...
# find source
pressure_25_to_1000_amplitude_time_averagevtu = FindSource('pressure_25_to_1000_amplitude_time_average.vtu')
...
pressure_averageLUT = GetColorTransferFunction('pressure_average')
...
pressure_averagePWF = GetOpacityTransferFunction('pressure_average')

# get 2D transfer function for 'pressure_average'
pressure_averageTF2D = GetTransferFunction2D('pressure_average')
